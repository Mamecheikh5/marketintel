...
def donnee():
    ...
    return render_template('resto/home/statistique.html', title="Statistiques" ,cote=cote, senegal=senegal,benin=benin,burkina=burkina,togo=togo)
...
def Max():
    ...
    return render_template('resto/home/capitale.html', title="Statistiques" ,nombres=nombres )

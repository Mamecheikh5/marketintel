...
@home.route('/restaurant/dashboard')
def dashboard():
    """
    Render the dashboard template on the /dashboard route
    """
    return render_template('restodashboard/home/dashboard.html', title="Dashboard")

@home.route('/restaurant/recherche', methods=['GET', 'POST'])
def recherche():
    form=rechercherForm()
    restaurant=None
    ...
    """
    return render_template('restodashboard/home/recherche.html',form=form, restaurant=restaurant, title="Recherche")

@home.route('/restaurant/recherche/<string:nom>', methods=['GET', 'POST'])
def regarder(nom):
    ...
    return render_template('restodashboard/home/recherche.html', title="restaurant" ,form=form, r=r,restaurant=restaurant )

@home.route('/restaurant/statistiques', methods=['GET', 'POST'])
def donnee():
    # prevent non-admins from accessing the page
    ...
    return render_template('restodashboard/home/statistique.html', title="Statistiques" ,cote=cote, senegal=senegal,benin=benin,burkina=burkina,togo=togo)


@home.route('/restaurant/capitale', methods=['GET', 'POST'])
def Max():
    Dakar = restaurants.query.filter_by(region='Dakar').count()
    Ouagadougou = restaurants.query.filter_by(region='Ouagadougou').count()
    Lome= restaurants.query.filter_by(region="Lomé").count()
    ...
    return render_template('restodashboard/home/capitale.html', title="Statistiques" ,nombres=nombres )
